                  ...
                  <div className="p-4 border border-orange-500/20 bg-orange-500/5 rounded-lg">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <Button size="sm" className="bg-orange-500 text-white hover:bg-orange-600 h-7 text-xs">Processar Cobranças</Button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-4 border border-blue-500/20 bg-blue-500/5 rounded-lg">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <Button size="sm" className="bg-blue-500 text-white hover:bg-blue-600 h-7 text-xs">Revisar Solicitações</Button>
                      </div>
                    </div>
                  </div>
                </div>
