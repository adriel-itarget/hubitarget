import { Gift, DollarSign, UserX, UserCheck } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto">
                ...
                <Card key={item.label}>
                  <CardContent className="pt-6">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <Badge variant="outline" className="text-green-600 border-green-500/30 bg-green-500/10">{item.badge}</Badge>
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            <Card className="lg:col-span-2">
              <CardHeader>
                <CardTitle>Crescimento de Usuários (2026)</CardTitle>
              </CardHeader>
              <CardContent>
                ...
                {campanhasAtivas.map(c => (
                  <div key={c.id} className="px-6 py-4 flex items-center gap-4 hover:bg-muted/30 transition-colors">
                    ...
                    <div className="text-right">
                      ...
                      <Badge variant="default" className="bg-green-500/10 text-green-600 border-green-500/30">Ativa</Badge>
                    </div>
                  </div>
                ))}
              </div>
